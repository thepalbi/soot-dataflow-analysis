...
public interface ValueVisitor<T> {
    ...
    /**
     * User-defined clone method, to have a common interface for when a new {@link ValueVisitor} has to be launched
     * against an internal value. For example, in the right operand of a {@link soot.jimple.DefinitionStmt}. Usually
     * used when the visitor needs some collaborators for working.
     *
